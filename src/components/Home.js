...
const Home = () => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        let teacherName = nameInput.current.value.replace(' ', '-');
    ...
    return (
        <div className="main-content home">
            ...
            <Link to="/teachers/John-Smith/HTML"> John Smith </Link>
            <Link to="/teachers/Joe-Schmoe/HTML"> Joe Schmoe </Link>
            <Link to="/teachers/Jane-Doe/HTML"> Jane Doe </Link>
            <form onSubmit={handleSubmit}>
                <input ref={nameInput} type="text" placeholder="Name" />
                <input ref={topicInput} type="text" placeholder="Topic" />
